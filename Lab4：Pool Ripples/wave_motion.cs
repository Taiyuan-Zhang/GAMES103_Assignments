...
public class wave_motion : MonoBehaviour 
{
	...
	}
	{
		...
		int li=(int)((block_p.x+5.0f)*10)-3;
		int ui=(int)((block_p.x+5.0f)*10)+3;
		int lj=(int)((block_p.z+5.0f)*10)-3;
		int uj=(int)((block_p.z+5.0f)*10)+3;
